...
public class RoverController {
  ...
  public ResponseEntity createTransaction(@RequestBody String commandLine) {
    ...
    Response response = new Response(
      ...
      invokerResult.getObstacle()
        .map(obstacle -> obstacle.getPosition().getX() + "," + obstacle.getPosition().getY())
        .orElse(null));
